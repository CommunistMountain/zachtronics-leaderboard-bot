...
enum class OmPuzzle(
    ...
    SAVERIO_S_TEST(DRM_CHAPTER_1, NORMAL, "Saverio's Test", "P201"),
    ELEMENTAL_COPPER(DRM_CHAPTER_1, NORMAL, "Elemental Copper", "P202"),
    SILVER_DUST(DRM_CHAPTER_1, NORMAL, "Silver Dust", "P203"),
    SAVERIO_S_TRANSFORMER(DRM_CHAPTER_1, PRODUCTION, "Saverio's Transformer", "P204"),
    MIXED_USE_LUBRICANT(DRM_CHAPTER_1, NORMAL, "Mixed-Use Lubricant", "P205"),
    METALLIC_TINCTURE(DRM_CHAPTER_1, NORMAL, "Metallic Tincture", "P206"),
    GALENA_SEPARATION(DRM_CHAPTER_1, NORMAL, "Galena Separation", "P207"),

    METAL_DIVISION(DRM_CHAPTER_2, NORMAL, "Metal Division", "P208"),
    SOLDER_WIRE(DRM_CHAPTER_2, POLYMER, "Solder Wire", "P209"),
    REACTIVE_LEAD(DRM_CHAPTER_2, NORMAL, "Reactive Lead", "P210"),
    FIREWORKS_POWDER(DRM_CHAPTER_2, NORMAL, "Fireworks Powder", "P211"),
    ARMOR_POLISH(DRM_CHAPTER_2, NORMAL, "Armor Polish", "P213"),

    INVARIANT_METAL(DRM_CHAPTER_3, NORMAL, "Invariant Metal", "P215"),
    VIA_QUICKSILVER(DRM_CHAPTER_3, NORMAL, "Via Quicksilver", "P216"),
    EX_MATERIA(DRM_CHAPTER_3, PRODUCTION, "Ex Materia", "P217"),
    EXPERIMENTAL_CATALYST(DRM_CHAPTER_3, NORMAL, "Experimental Catalyst", "P220"),
    PATTERN_METAL(DRM_CHAPTER_3, NORMAL, "Pattern Metal", "P221"),

    VAN_BERLO_S_WHEEL(JOURNAL_XCIX_I, NORMAL, "Van Berlo's Wheel", "P054"),
    VAN_BERLO_S_CHAIN(JOURNAL_XCIX_I, POLYMER, "Van Berlo's Chain", "P055"),
    REACTIVE_CINNABAR(JOURNAL_XCIX_I, NORMAL, "Reactive Cinnabar", "P056"),
    SILVER_CAUSTIC(JOURNAL_XCIX_I, NORMAL, "Silver Caustic", "P057"),
    LAMBENT_II_IX(JOURNAL_XCIX_I, NORMAL, "Lambent II/IX", "P058"),

    EXPLORER_S_SALVE(JOURNAL_XCIX_II, NORMAL, "Explorer's Salve", "P059"),
    PRESERVATIVE_SALT(JOURNAL_XCIX_II, NORMAL, "Preservative Salt", "P060"),
    SAILCLOTH_THREAD(JOURNAL_XCIX_II, POLYMER, "Sailcloth Thread", "P061"),
    BUOYANT_CABLE(JOURNAL_XCIX_II, POLYMER, "Buoyant Cable", "P062"),
    SPYGLASS_CRYSTAL(JOURNAL_XCIX_II, NORMAL, "Spyglass Crystal", "P063"),

    RAVARI_S_WHEEL(JOURNAL_XCIX_III, NORMAL, "Ravari's Wheel", "P064"),
    LUBRICATING_FILAMENT(JOURNAL_XCIX_III, POLYMER, "Lubricating Filament", "P065"),
    RESONANT_CRYSTAL(JOURNAL_XCIX_III, NORMAL, "Resonant Crystal", "P066"),
    REFINED_BRONZE(JOURNAL_XCIX_III, POLYMER, "Refined Bronze", "P067"),
    ABLATIVE_CRYSTAL(JOURNAL_XCIX_III, NORMAL, "Ablative Crystal", "P068"),

    PROOF_OF_COMPLETENESS(JOURNAL_XCIX_IV, NORMAL, "Proof of Completeness", "P069"),
    WHEEL_REPRESENTATION(JOURNAL_XCIX_IV, NORMAL, "Wheel Representation", "P070"),
    SYNTHESIS_VIA_ALCOHOL(JOURNAL_XCIX_IV, NORMAL, "Synthesis via Alcohol", "P071"),
    UNIVERSAL_COMPOUND(JOURNAL_XCIX_IV, NORMAL, "Universal Compound", "P072"),

    GENERAL_ANAESTHETIC(JOURNAL_XCIX_V, NORMAL, "General Anaesthetic", "P086"),
    WAKEFULNESS_POTION(JOURNAL_XCIX_V, NORMAL, "Wakefulness Potion", "P088"),
    SUTURE_THREAD(JOURNAL_XCIX_V, POLYMER, "Suture Thread", "P085"),
    BLOOD_STANCHING_POWDER(JOURNAL_XCIX_V, NORMAL, "Blood-Stanching Powder", "P087"),
    TONIC_OF_HYDRATION(JOURNAL_XCIX_V, NORMAL, "Tonic of Hydration", "P089"),

    HEXSTABILIZED_SALT(JOURNAL_XCIX_VI, PRODUCTION, "Hexstabilized Salt", "P091b"),
    LUSTRE(JOURNAL_XCIX_VI, PRODUCTION, "Lustre", "P090"),
    LAMPLIGHT_GAS(JOURNAL_XCIX_VI, PRODUCTION, "Lamplight Gas", "P092"),
    CONDUCTIVE_ENAMEL(JOURNAL_XCIX_VI, PRODUCTION, "Conductive Enamel", "P093"),
    WELDING_THERMITE(JOURNAL_XCIX_VI, PRODUCTION, "Welding Thermite", "P094"),

    VAN_BERLO_S_PIVOTS(JOURNAL_XCIX_VII, NORMAL, "Van Berlo's Pivots", "P096"),
    REACTIVE_GOLD(JOURNAL_XCIX_VII, NORMAL, "Reactive Gold", "P095"),
    ASSASSIN_S_FILAMENT(JOURNAL_XCIX_VII, POLYMER, "Assassin's Filament", "P097"),
    VAPOROUS_SOLVENT(JOURNAL_XCIX_VII, NORMAL, "Vaporous Solvent", "P098"),
    ALCHEMICAL_SLAG(JOURNAL_XCIX_VII, NORMAL, "Alchemical Slag", "P099"),

    EXPLOSIVE_VICTRITE(JOURNAL_XCIX_VIII, NORMAL, "Explosive Victrite", "P100"),
    CELESTIAL_THREAD(JOURNAL_XCIX_VIII, POLYMER, "Celestial Thread", "P101"),
    VISILLARY_ANAESTHETIC(JOURNAL_XCIX_VIII, NORMAL, "Visillary Anaesthetic", "P102"),
    ANIMISMUS_BUFFER(JOURNAL_XCIX_VIII, NORMAL, "Animismus Buffer", "P104"),
    ELECTRUM_SEPARATION(JOURNAL_XCIX_VIII, POLYMER, "Electrum Separation", "P103"),

    HYPER_VOLATILE_GAS(JOURNAL_XCIX_IX, NORMAL, "Hyper-volatile Gas", "P106"),
    VANISHING_MATERIAL(JOURNAL_XCIX_IX, PRODUCTION, "Vanishing Material", "P105"),
    SYNTHETIC_MALACHITE(JOURNAL_XCIX_IX, PRODUCTION, "Synthetic Malachite", "P109"),
    EMBALMING_FLUID(JOURNAL_XCIX_IX, NORMAL, "Embalming Fluid", "P108"),
    QUINTESSENTIAL_MEDIUM(JOURNAL_XCIX_IX, NORMAL, "Quintessential Medium", "P107"),

    TOUCHSTONE(JOURNAL_XCIX_X, NORMAL, "Touchstone", "P245"),
    LUMINOUS_VAPOR(JOURNAL_XCIX_X, NORMAL, "Luminous Vapor", "P247"),
    BEAUTY_SALVE(JOURNAL_XCIX_X, NORMAL, "Beauty Salve", "P246"),
    CULTIVATION_TONIC(JOURNAL_XCIX_X, NORMAL, "Cultivation Tonic", "P249"),
    BANDAGE_THREAD(JOURNAL_XCIX_X, POLYMER, "Bandage Thread", "P248"),

    COMPOUND_ANAESTHETIC(JOURNAL_XCIX_XI, NORMAL, "Compound Anaesthetic", "P244"),
    GREEN_VITRIOL(JOURNAL_XCIX_XI, NORMAL, "Green Vitriol", "P240"),
    SLEEPING_TONIC(JOURNAL_XCIX_XI, NORMAL, "Sleeping Tonic", "P242"),
    RESONANT_DUST(JOURNAL_XCIX_XI, NORMAL, "Resonant Dust", "P243"),
    BLUE_VITRIOL(JOURNAL_XCIX_XI, NORMAL, "Blue Vitriol", "P241"),

    SOPHICK_MERCURY(JOURNAL_XCIX_XII, NORMAL, "Sophick Mercury", "P250"),
    RECLAIMED_GOLD(JOURNAL_XCIX_XII, NORMAL, "Reclaimed Gold", "P254"),
    DENTAL_AMALGAM(JOURNAL_XCIX_XII, PRODUCTION, "Dental Amalgam", "P252"),
    CUPRITE(JOURNAL_XCIX_XII, NORMAL, "Cuprite", "P253"),
    EXPLOSIVE_ALLOY(JOURNAL_XCIX_XII, NORMAL, "Explosive Alloy", "P251"),

    LODESTONE(JOURNAL_CVIII_I, NORMAL, "Lodestone", "P256"),
    MOORING_CABLE(JOURNAL_CVIII_I, POLYMER, "Mooring Cable", "P255"),
    ESSENCE_OF_CITRUS(JOURNAL_CVIII_I, NORMAL, "Essence of Citrus", "P257"),
    LIGHTHOUSE_MIRROR(JOURNAL_CVIII_I, NORMAL, "Lighthouse Mirror", "P258"),
    GRENADE_PELLET(JOURNAL_CVIII_I, NORMAL, "Grenade Pellet", "P259"),
    ...
    SIMULACRUM(TOURNAMENT_2024, NORMAL, "Simulacrum", "w3210138102", "OM2024_W0_Simulacrum"),
    // BLUE_VITRIOL(TOURNAMENT_2024, NORMAL, "Blue Vitriol", "w3210151153", "OM2024_W1_Blue_Vitriol"),
    LOCAL_ANAESTHETIC(TOURNAMENT_2024, NORMAL, "Local Anaesthetic", "w3210168922", "OM2024_W2_Local_Anaesthetic"),
    // TOUCHSTONE(TOURNAMENT_2024, NORMAL, "Touchstone", "w3210172577", "OM2024_W3_Touchstone"),
    CHUNKY_MORS(TOURNAMENT_2024, PRODUCTION, "Chunky Mors", "w3210174680", "OM2024_W4_Dental_Amalgam"),
    LATCH_HOOK_FIREWORKS(TOURNAMENT_2024, NORMAL, "Latch-Hook Fireworks", "w3210177679", "OM2024_W5_Latch-Hook_Fireworks"),
    PLASTIC(TOURNAMENT_2024, NORMAL, "Plastic", "w3210182753", "OM2024_WB_Plastic"),
    ...
    PHILOSOPHER_S_CATALYST(WEEKLIES_1, NORMAL, "Philosopher's Catalyst", "w2868339730", "OM2022Weeklies_PhilosophersCatalyst"),
