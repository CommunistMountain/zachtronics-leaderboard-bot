...
enum class OmGroup(val collection: OmCollection, override val displayName: String) : Group {
    ...
    JOURNAL_XCIX_I(JOURNAL_XCIX, "XCIX Issue I"),
    JOURNAL_XCIX_II(JOURNAL_XCIX, "XCIX Issue II"),
    JOURNAL_XCIX_III(JOURNAL_XCIX, "XCIX Issue III"),
    JOURNAL_XCIX_IV(JOURNAL_XCIX, "XCIX Issue IV"),
    JOURNAL_XCIX_V(JOURNAL_XCIX, "XCIX Issue V"),
    JOURNAL_XCIX_VI(JOURNAL_XCIX, "XCIX Issue VI"),
    JOURNAL_XCIX_VII(JOURNAL_XCIX, "XCIX Issue VII"),
    JOURNAL_XCIX_VIII(JOURNAL_XCIX, "XCIX Issue VIII"),
    JOURNAL_XCIX_IX(JOURNAL_XCIX, "XCIX Issue IX"),
    JOURNAL_XCIX_X(JOURNAL_XCIX, "XCIX Issue X"),
    JOURNAL_XCIX_XI(JOURNAL_XCIX, "XCIX Issue XI"),
    JOURNAL_XCIX_XII(JOURNAL_XCIX, "XCIX Issue XII"),
